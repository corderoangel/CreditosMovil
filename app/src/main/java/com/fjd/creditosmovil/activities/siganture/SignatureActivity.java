...
public class SignatureActivity extends AppCompatActivity {
     ...
     * Configura el botón de limpiar firma para borrar la firma capturada y el botón de guardar firma para guardar la firma
     * capturada.
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveSignatureButton.setOnClickListener(v -> saveSignature());
    }
     ...
     * La firma se guarda como una entidad de fotos en la base de datos local, con el tipo "SIGNATURE".
    ...
    private void saveSignature() {
        try {
            ...
            fotosEntity.TYPE = DataProcess.SIGNATURE;
            /////////////////////////////////////////////////////////
